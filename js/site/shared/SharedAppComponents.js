                    ...
                    <div>
                        <ul class="navbar-nav" >
                            <li class="nav-item px-5">         
                                <a class="nav-link d-inline ${activePage === 'log' ? 'active' : ''}" aria-current="page" href="/MyJot/pages/log.html"><i class="fas fa-book fa-lg me-2"></i>Log</a>
                            </li>
                            <li class="nav-item px-5">               
                                <a class="nav-link d-inline ${activePage === 'stats' ? 'active' : ''}" href="/MyJot/pages/stats.html"><i class="fa-solid fa-chart-column fa-lg me-2"></i>Stats</a>
                            </li>
                            <li class="nav-item px-5">                  
